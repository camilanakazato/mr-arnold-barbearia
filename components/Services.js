  ...
  return (
    <section className="servicos">
      ...
      <div className="servicos-grupo">
        <h3><Image src="/imgs/cabelo-icon.png" alt="Cabelo" width={32} height={32} className="servico-icone" /> Cabelo</h3>
        <div className="servicos-cards">
          ...
          <div className="servico-card servico-agendamento">
            <p className="servico-agendamento-texto">Escolha todos os serviços que deseja de uma só vez e garanta seu atendimento com nossos profissionais.<br/>
            Clique para agendar pelo site ou baixe o app TRINKS e tenha tudo na palma da mão.</p>
      ...
      {/* Barba */}
      <div className="servicos-grupo">
        <h3><Image src="/imgs/barba-icon.png" alt="Barba" width={32} height={32} className="servico-icone" /> Barba</h3>
        <div className="servicos-cards">
          <div className="servico-card">
            <h4>Barba</h4>
      ...
      {/* Corte e Barba */}
      <div className="servicos-grupo">
        <h3><Image src="/imgs/combo-icon.png" alt="Combo Corte e Barba" width={32} height={32} className="servico-icone" /> Corte e Barba</h3>
        <div className="servicos-cards">
          <div className="servico-card">
            <h4>Combo</h4>
      ...
      {/* Sobrancelha */}
      <div className="servicos-grupo">
        <h3><Image src="/imgs/sobrancelha-icon.png" alt="Sobrancelha" width={32} height={32} className="servico-icone" /> Sobrancelha</h3>
        <div className="servicos-cards">
          <div className="servico-card">
            <h4>Sobrancelha</h4>
      ...
      {/* Depilações */}
      <div className="servicos-grupo">
        <h3><Image src="/imgs/depilacao-icon.png" alt="Depilação" width={32} height={32} className="servico-icone" /> Depilações</h3>
        <div className="servicos-cards">
          <div className="servico-card">
